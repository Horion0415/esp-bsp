...
esp_err_t bsp_display_new(const bsp_display_config_t *config, esp_lcd_panel_handle_t *ret_panel, esp_lcd_panel_io_handle_t *ret_io)
{
    ...
    ILI9881C_PANEL_BUS_DSI_2CH_CONFIG();
    ...
    esp_lcd_dpi_panel_config_t dpi_config = ILI9881C_800_1280_PANEL_60HZ_DPI_CONFIG(MIPI_DPI_PX_FORMAT);
    ...
    ESP_ERROR_CHECK(esp_lcd_new_panel_ili9881c(mipi_dbi_io, &panel_config, &mipi_dpi_panel));
#elif LCD_CONTROLLER_EK79007
...
//    gpio_set_level(27, 1);
    ...
    ESP_ERROR_CHECK(esp_lcd_panel_swap_xy(mipi_dpi_panel, true));
#endif
