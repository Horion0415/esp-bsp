...
#define GROUP1_PIN_NUM 6
const int group1_pins[GROUP1_PIN_NUM] = {10, 8, 6, 53, 51, 38};

// Define second group of GPIO pins (as receiver and sender)
#define GROUP2_PIN_NUM 6
const int group2_pins[GROUP2_PIN_NUM] = {34, 7, 54, 52, 50, 37};
